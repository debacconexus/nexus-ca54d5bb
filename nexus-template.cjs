...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Microfinance Borrower Portfolio Management";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Borrower";
process.env.TABLE_NAME = process.env.TABLE_NAME || "borrower_records";
'use strict';
